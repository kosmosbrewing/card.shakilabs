...
//
// On 2026-09-15 a live audit found /overseas-payment scrolling +31px. The cause
// is always the same shape - a <table> wider than the viewport that no ancestor
// clips or scrolls. Wide tables are fine; what is not fine is letting the table
// size the document, so the fix is a scroll wrapper, never shrinking the data.
//
...
function resolveFile(urlPath) {
  ...
  // cleanUrls: /overseas-payment -> dist/overseas-payment/index.html
