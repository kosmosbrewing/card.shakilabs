...
<template>
  <div class="retro-panel overflow-hidden">
    ...
    <div class="grid gap-px bg-border/60 sm:grid-cols-2">
      <div class="bg-card p-4 sm:p-5">
        ...
        <div class="space-y-1.5 text-body">
          ...
          <p class="tabular-nums text-status-success">
    ...
    <div class="border-t border-border/60 bg-status-danger/10 px-4 py-3 text-body font-semibold text-status-danger sm:px-5">
