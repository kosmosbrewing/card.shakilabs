...
export const DCC_MARKUP_MIN = 0;
export const DCC_MARKUP_MAX = 0.2;
export const DCC_MARKUP_MIN_PERCENT = DCC_MARKUP_MIN * 100;
export const DCC_MARKUP_MAX_PERCENT = DCC_MARKUP_MAX * 100;
...
export const dccMarkupSchema = z.number().min(DCC_MARKUP_MIN).max(DCC_MARKUP_MAX);
