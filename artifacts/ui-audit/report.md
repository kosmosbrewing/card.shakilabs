...
## 1. 요약
- 서비스: Card; 초기 이슈 6개, 해결 5개, 잔여 1개.
- 현재 이슈: P0 0 / P1 0 / P2 0 / P3 1.
...
| ID | 초기 심각도 | 초기 문제 | 상태 |
|---|---|---|---|
| CARD-AUD-001 | P1 | 200% 확대에서 카드 순위·비교표·설명이 한 글자 폭 열로 붕괴합니다. | resolved |
| CARD-AUD-002 | P1 | 월 주유비 text input과 range에 접근 가능한 label이 없습니다. | resolved |
| CARD-AUD-003 | P2 | 12px 미만 텍스트가 annual-fee에서 520개, overseas-payment에서 257개 측정됩니다. | resolved |
| CARD-AUD-004 | P2 | 공공 유가·환율 요청이 로컬 기본 실행에서 404이며 console error를 발생시킵니다. | resolved |
| CARD-AUD-005 | P2 | NotFound 화면 h1Count가 0입니다. | resolved |
...
- 현재: client/src/assets/css/main.css 458줄
